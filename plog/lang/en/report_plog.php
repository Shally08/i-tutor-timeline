 ...
 */
$string['plog:viewcourse'] = 'View course charts';
$string['plog:viewown'] = 'View own charts';
$string['page'] = 'Page {$a}';
$string['choose-personal-log'] = 'Choose which report to see';
...
$string['pluginname'] = 'Personal Logs';
$string['plogs'] = 'Personal logs';
